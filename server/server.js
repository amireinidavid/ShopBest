...
mongoose
  .connect(
    "mongodb+srv://Daveflix:5G4valPfuwoRdmhy@daveflix.lkvuzdj.mongodb.net/Daveflix?retryWrites=true&w=majority&appName=Daveflix"
  )
...
app.use(
  cors({
    origin: "https://shop-best.vercel.app",
